 ...
 *
 * <p>Manages file fingerprint cache for deduplication and change detection.
...
public final class FingerprintRepository {
     ...
     */
    public void update(String filePath, String fileHash, long fileSize, Instant lastModified) throws SQLException {
        String sql = """
     ...
     */
    public void upsert(String filePath, String fileHash, long fileSize, Instant lastModified) throws SQLException {
        ...
        if (existing.isPresent()) {
            ...
            FileFingerprintEntity fingerprint = FileFingerprintEntity.builder()
                    .filePath(filePath)
                    .fileHash(fileHash)
                    .fileSize(fileSize)
