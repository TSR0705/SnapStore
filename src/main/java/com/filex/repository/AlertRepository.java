 ...
 *
 * <p>Manages alert records generated from suspicious file activity.
...
public final class AlertRepository {
    ...
    public long insert(AlertEntity alert) throws SQLException {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql, PreparedStatement.RETURN_GENERATED_KEYS)) {
            ...
            pstmt.setObject(9, alert.getAcknowledgedAt() != null ? alert.getAcknowledgedAt().toEpochMilli() : null);
    ...
    public Page<AlertEntity> findUnacknowledged(PageRequest pageRequest) throws SQLException {
        ...
        String sql = "SELECT * FROM alerts WHERE acknowledged = 0 ORDER BY timestamp DESC LIMIT ? OFFSET ?";
     ...
     */
    public Page<AlertEntity> findBySeverity(String severity, PageRequest pageRequest) throws SQLException {
        List<AlertEntity> content = new ArrayList<>();
