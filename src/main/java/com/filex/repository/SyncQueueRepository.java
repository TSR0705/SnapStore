 ...
 *
 * <p>Manages the offline-first sync queue for backend synchronization. All SQL is encapsulated here
...
public final class SyncQueueRepository {
  ...
  public long insert(SyncQueueEntity entry) throws SQLException {
    ...
    try (PreparedStatement pstmt =
      ...
      pstmt.setObject(
          7, entry.getLastAttempt() != null ? entry.getLastAttempt().toEpochMilli() : null);
