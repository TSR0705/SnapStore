 ...
 *
 * <p>Provides type-safe get/set operations for common setting types. All settings are stored as
 * strings with type metadata for proper deserialization.
 */
public final class SettingsRepository {
  ...
  public void save(String key, String value, String valueType, String description)
      throws SQLException {
    String sql =
        """
