 ...
 *
 * <p>All SQL is encapsulated here. Uses PreparedStatement exclusively for query safety. Supports
...
public final class FileEventRepository {
  ...
  public Page<FileEventEntity> findSuspicious(PageRequest pageRequest) throws SQLException {
    ...
    String sql =
        "SELECT * FROM file_events WHERE suspicious = 1 ORDER BY timestamp DESC LIMIT ? OFFSET ?";
