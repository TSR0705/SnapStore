 ...
 *
 * <p>Migrations are executed in version order during application startup.
 * Each migration is idempotent and can be safely re-run if it has already
 * been applied (the migration system tracks applied versions).
 */
