 ...
 *
 * <p>CRITICAL FIX: Prevents duplicate sequence numbers at the same timestamp, ensuring
 * deterministic timeline ordering under concurrent load.
 *
 * <p>Forensic Principle: Timeline reconstruction must be deterministic and replay-safe. The
 * combination of (timestamp, sequence_number) must be globally unique.
 */
