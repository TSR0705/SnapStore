 ...
 *
 * <p>Migrates from TEXT datetime format to INTEGER epoch milliseconds for consistency with all
 * other tables.
 *
 * <p>This migration is idempotent and safe to run on both:
 *
 * <ul>
 *   <li>Fresh databases (where schema_version already uses INTEGER)
 *   <li>Existing databases (where schema_version uses TEXT)
 * </ul>
 */
