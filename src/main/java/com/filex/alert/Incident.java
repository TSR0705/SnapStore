 ...
 *
 * <p>An incident aggregates one or more related detections into a single actionable security event.
 * Incidents track:
 *
 * <ul>
 *   <li>Correlation metadata
 *   <li>Evidence chain (linked detections)
 *   <li>Lifecycle status
 *   <li>Severity and confidence
 *   <li>Temporal tracking (created, updated, last seen)
 * </ul>
 *
...
public final class Incident {
  ...
  private Incident(Builder builder) {
    ...
    this.evidenceSummary =
        builder.evidenceSummary != null ? Map.copyOf(builder.evidenceSummary) : Map.of();
