...
public final class AlertMetrics {
    ...
    public String toString() {
        return "AlertMetrics{" +
                "totalAlertsProcessed=" + totalAlertsProcessed +
                ", totalIncidentsCreated=" + totalIncidentsCreated +
                ", totalIncidentsMerged=" + totalIncidentsMerged +
                ", totalAlertsSuppressed=" + totalAlertsSuppressed +
                ", totalCorrelationFailures=" + totalCorrelationFailures +
                ", totalDroppedAlerts=" + totalDroppedAlerts +
