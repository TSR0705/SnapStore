...
public interface Event {
  ...
  /** Returns the unique identifier for this event. Used for tracing and correlation. */
  String getEventId();
  ...
  /**
   * Returns the source component that created this event. Examples: "Bootstrap", "DatabaseManager",
   * "ConfigManager"
   */
  String getSource();

  /**
   * Returns optional correlation ID for event chains. Used to trace related events across the
   * system.
   */
