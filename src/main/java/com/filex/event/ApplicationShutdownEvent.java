 ...
 *
 * <p>Subscribers should use this event to release resources, flush buffers, and cancel pending
 * work. The event is published before the database and executor services are closed.
 */
