 ...
 *
 * <p>Maintains investigation state for replay continuity and analysis context. Sessions are
 * immutable snapshots that can be used to resume investigation from a specific point.
 *
...
public final class InvestigationSession {
  ...
  public InvestigationCriteria getCriteria() {
    return criteria;
  }

  public String getFocusIncidentId() {
    return focusIncidentId;
  }

  public String getFocusCorrelationId() {
    return focusCorrelationId;
  }

  public Instant getReplayPosition() {
  ...
  public boolean hasFocusIncident() {
    return focusIncidentId != null;
  }

  public boolean hasFocusCorrelation() {
    return focusCorrelationId != null;
  }

  public boolean hasReplayPosition() {
    return replayPosition != null;
  }
