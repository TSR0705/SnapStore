 ...
 *
 * <p>Tracks query performance, failure rates, and resource usage for
    ...
    public record InvestigationMetricsSnapshot(
        ...
        public String toString() {
            return String.format(
                    ...
                    totalQueries, failedQueries, getAverageQueryTimeMs(),
                    incidentQueriesExecuted, evidenceQueriesExecuted, timelineQueriesExecuted,
                    correlationTraversals, replayNavigations, oversizedResults
            );
        }
    }
}
