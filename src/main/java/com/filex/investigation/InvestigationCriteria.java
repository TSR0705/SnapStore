 ...
 *
 * <p>Provides composable filtering for incident exploration, timeline analysis, and evidence
 * traversal. All criteria are optional and combine with AND logic.
 *
...
public final class InvestigationCriteria {
  ...
  public Set<String> getConfidences() {
    return confidences;
  }
  ...
  public boolean hasConfidenceFilter() {
  ...
  public boolean hasCorrelationFilter() {
  ...
  public String toString() {
    return "InvestigationCriteria{"
        ...
        + statuses
        + ", timeRange="
        + (hasTimeRangeFilter() ? startTime + " to " + endTime : "none")
        + ", maxResults="
        + maxResults
        + '}';
  }
