 ...
 *
 * <p>Contains incidents, evidence, and timeline events matching the investigation criteria, along
 * with metadata about the query execution.
 *
...
public final class InvestigationResult<T> {
  ...
  private InvestigationResult(Builder<T> builder) {
    ...
    this.queryTimestamp =
        Objects.requireNonNull(builder.queryTimestamp, "queryTimestamp must not be null");
