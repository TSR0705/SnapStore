 ...
 *
 * <p>Provides a lightweight view of incident data optimized for investigation
 * queries and forensic analysis. Does not include full metadata to reduce
 * memory footprint during large-scale queries.
 *
...
public final class IncidentSummary {
    ...
    public static final class Builder {
        ...
        public Builder detectionCount(int detectionCount) { this.detectionCount = detectionCount; return this; }
        public Builder evidenceCount(long evidenceCount) { this.evidenceCount = evidenceCount; return this; }
