 ...
 *
 * <p>Monitoring events represent raw filesystem changes detected by
 * the WatchService. These are normalized and deduplicated before
 * being persisted or processed by detection logic.
 */
