 ...
 *
 * <p>Provides observability into monitoring state without
...
public final class MonitoringMetrics {
    ...
    public String toString() {
        return "MonitoringMetrics{" +
                ...
                ", registeredPathCount=" + registeredPathCount +
                ", totalEventsDetected=" + totalEventsDetected +
                ", totalEventsNormalized=" + totalEventsNormalized +
                ", totalEventsDeduplicated=" + totalEventsDeduplicated +
                ", totalOverflowEvents=" + totalOverflowEvents +
                ", totalInvalidatedWatches=" + totalInvalidatedWatches +
