 ...
 *
 * <p>Prevents duplicate events (especially MODIFY storms) from flooding
 * the event pipeline by collapsing events for the same path and operation
...
public final class EventDeduplicator {
    ...
    private static final class DedupKey {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(path, dedupKey.path) &&
                   Objects.equals(operation, dedupKey.operation);
        }
