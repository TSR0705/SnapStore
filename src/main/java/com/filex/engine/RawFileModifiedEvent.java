 ...
 *
 * <p>This is a raw, unnormalized event from the WatchService. MODIFY events are particularly noisy
 * and require aggressive deduplication to prevent event storms.
 */
