 ...
 *
 * <ul>
 *   <li>{@link AppContext} only
 *   <li>{@link AppContext} and {@link WorkspaceService}
 * </ul>
 *
 * <p>The factory uses reflection to find the appropriate constructor and inject dependencies.
 *
 * <p>This approach keeps controllers decoupled from static state and makes them trivially testable
 * — tests can construct controllers with mock dependencies.
 */
public final class ControllerFactory {
  ...
  /**
   * Creates a controller instance of the given class, injecting dependencies via constructor.
   *
    ...
    try {
      ...
      try {
        Constructor<?> constructor =
            controllerClass.getDeclaredConstructor(AppContext.class, WorkspaceService.class);
        ...
        log.debug(
            "Instantiated controller with WorkspaceService: {}", controllerClass.getSimpleName());
        return instance;
      ...
      throw new ViewLoadException(
          "Controller "
              ...
              + " must declare a constructor accepting AppContext or (AppContext, WorkspaceService).",
          e);
    } catch (Exception e) {
      throw new ViewLoadException(
