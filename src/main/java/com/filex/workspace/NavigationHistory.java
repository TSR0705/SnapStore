 ...
 *
 * <p>Maintains a stack of workspace snapshots for back/forward navigation.
 * Implements bounded pruning to prevent unbounded memory growth.
 *
...
public final class NavigationHistory {
    ...
    /**
     * Navigates to a new state, pushing current state to back stack.
     * Clears forward stack (new navigation invalidates forward history).
     *
    ...
    /**
     * Prunes history if it exceeds maximum size.
     * Removes oldest entries from back stack.
     */
