 ...
 *
 * <p>Represents the complete state of an operator's investigation workspace
 * at a specific point in time. Used for:
 * <ul>
 *   <li>State synchronization across UI panels</li>
 *   <li>Session persistence and restoration</li>
 *   <li>Undo/redo foundation (future)</li>
 *   <li>Workspace state debugging</li>
 * </ul>
 *
 * <p>Design principles:
 * <ul>
 *   <li><b>Immutable</b> — thread-safe, no defensive copying needed</li>
 *   <li><b>Minimal</b> — only deterministic state, no UI object graphs</li>
 *   <li><b>Serializable-ready</b> — all fields are primitives or simple types</li>
 *   <li><b>Builder pattern</b> — fluent API for state transitions</li>
 * </ul>
 *
...
public final class WorkspaceState {
    ...
    public static final class Builder {
        ...
        public Builder navigationContext(NavigationContext navigationContext) {
            this.navigationContext = Objects.requireNonNull(navigationContext, "navigationContext must not be null");
            return this;
        }
    ...
    public String toString() {
        return "WorkspaceState{" +
                ...
                ", activeReplayCheckpoint=" + activeReplayCheckpoint +
