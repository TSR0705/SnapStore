 ...
 *
 * <ul>
 *   <li>Navigation operations and latency
 *   <li>Replay render operations and latency
 *   <li>State synchronization operations
 *   <li>Session restoration operations
 *   <li>Async query coordination
 *   <li>Failure counts
 * </ul>
 *
 * <p>All counters use {@link AtomicLong} for thread-safe updates. Metrics are lightweight and have
...
public final class WorkspaceMetrics {
  ...
  public record WorkspaceMetricsSnapshot(
    ...
    public double averageReplayRenderLatencyMs() {
      return replayRenderOperations > 0
          ? (double) replayRenderLatencyMs / replayRenderOperations
          : 0.0;
    }

    public double averageSessionRestorationLatencyMs() {
      return sessionRestorations > 0
          ? (double) sessionRestorationLatencyMs / sessionRestorations
          : 0.0;
    }
