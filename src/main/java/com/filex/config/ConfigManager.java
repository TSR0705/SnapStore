 ...
 * <ol>
 *   <li>Environment variable {@code FILEX_HOME} — explicit override</li>
 *   <li>OS-specific user data directory (AppData on Windows, ~/.local/share on Linux/macOS)</li>
 *   <li>User home fallback</li>
 * </ol>
 *
 * <p>This class is stateless after construction. It creates required
 * directories eagerly so the rest of the bootstrap can assume they exist.
 */
public final class ConfigManager {
    ...
    /**
     * Resolves the application configuration and ensures all required
     * directories exist on the filesystem.
     *
