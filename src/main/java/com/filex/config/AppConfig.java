 ...
 *
 * <p>Holds all resolved paths and settings for the current runtime. Constructed once by {@link
 * ConfigManager} and passed through the dependency graph — never accessed statically.
 */
public record AppConfig(
  ...
  /** Validates that all required paths are non-null. Java record compact constructor. */
  public AppConfig {
  ...
  public String summary() {
    return String.format(
        "[AppConfig] name=%s version=%s home=%s debug=%b", appName, appVersion, appHome, debugMode);
  }
}
