 ...
 *
 * <p>Contains detection metadata including severity, confidence, description, and optional context
 * data.
 */
public final class DetectionResult {
  ...
  public static DetectionResult detected(
      Severity severity, Confidence confidence, String description) {
  ...
  public static DetectionResult detected(
      Severity severity, Confidence confidence, String description, Map<String, Object> context) {
