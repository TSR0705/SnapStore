 ...
 *
 * <p>Triggers when hidden files are created (files starting with '.' on Unix or with hidden
 * attribute on Windows), which may indicate malware attempting to conceal its presence.
 *
 * <p>Note: This rule has LOW confidence as hidden files are common in legitimate scenarios (e.g.,
