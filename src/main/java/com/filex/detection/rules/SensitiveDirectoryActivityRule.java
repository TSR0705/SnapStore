 ...
 *
 * <p>Triggers when unusual file operations occur in sensitive system or user directories that are
...
public final class SensitiveDirectoryActivityRule implements DetectionRule {
  ...
  private static final Set<String> SENSITIVE_DIRECTORIES =
      Set.of(
          "Documents",
          "Desktop",
          "Pictures",
  ...
  public DetectionResult evaluate(DetectionContext context) {
    ...
    if (recentSensitiveActivity >= ACTIVITY_THRESHOLD) {
      log.warn(
          "Elevated activity in sensitive directory: {} ({} operations in {}ms)",
          sensitiveDir,
          recentSensitiveActivity,
      ...
      return DetectionResult.detected(
          ...
          Confidence.MEDIUM,
          String.format(
              "Elevated activity in sensitive directory '%s': %d operations in %d seconds",
