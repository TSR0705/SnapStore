 ...
 *
 * <p>Detection events represent suspicious activities identified
 * by the detection engine. They are published to the EventBus
 * for downstream processing (persistence, alerting, etc.).
 */
public abstract class DetectionEvent extends AppEvent {
    ...
    protected DetectionEvent(
        ...
        this.affectedPaths = affectedPaths != null ?
                Collections.unmodifiableList(affectedPaths) : List.of();
    }
    ...
    public String toString() {
        return getClass().getSimpleName() + "{" +
                ...
                ", affectedPaths=" + affectedPaths.size() + " path(s)" +
                ", eventId='" + eventId() + '\'' +
                '}';
    }
}
