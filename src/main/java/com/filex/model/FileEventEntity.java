 ...
 *
 * <p>Represents an immutable file system event captured by the monitoring engine.
 * Events are never modified after creation — they form an append-only audit log.
 *
 * <p>This is a persistence entity, not a UI model. UI layers should map this
 * to view-specific models as needed.
 */
public final class FileEventEntity {
    ...
    public static final class Builder {
        ...
        public Builder processId(Integer processId) { this.processId = processId; return this; }
