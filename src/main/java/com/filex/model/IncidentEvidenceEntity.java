 ...
 *
 * <p>Links detection events to incidents, forming an immutable evidence chain.
 * Each evidence record represents a single detection that contributed to an incident.
 *
