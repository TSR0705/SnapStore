 ...
 *
 * <p>Timeline records provide chronological reconstruction of security events,
 * linking incidents, evidence, and detections in a deterministic order.
 *
 * <p>Timeline records are immutable and ordered by:
 * <ol>
 *   <li>Timestamp (primary ordering)</li>
 *   <li>Sequence number (deterministic tie-breaking)</li>
 * </ol>
 *
