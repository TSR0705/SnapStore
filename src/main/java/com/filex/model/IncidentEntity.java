 ...
 *
 * <p>Represents a correlated security incident that aggregates one or more
 * related detections. Incidents form the core of the forensic timeline and
 * are immutable once persisted (updates create new versions).
 *
