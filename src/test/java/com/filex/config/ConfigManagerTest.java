...
class ConfigManagerTest {
  ...
  void testResolveCreatesValidConfig() {
    ...
    assertTrue(
        config.databaseFile().toString().endsWith(AppConfig.DB_FILENAME),
  ...
  void testResolveCreatesDirectories() {
    ...
    assertTrue(config.appHome().toFile().exists(), "appHome directory should exist");
    assertTrue(config.logsDir().toFile().exists(), "logsDir directory should exist");
    assertTrue(config.dataDir().toFile().exists(), "dataDir directory should exist");
    assertTrue(config.configDir().toFile().exists(), "configDir directory should exist");
  }
