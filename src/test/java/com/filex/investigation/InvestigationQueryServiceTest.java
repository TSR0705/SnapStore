...
class InvestigationQueryServiceTest {
    ...
    void testFindIncidentsWithNoCriteria() throws Exception {
        ...
        InvestigationResult<IncidentSummary> result = investigationService.findIncidents(criteria, 0, 10);
    ...
    void testPaginationWorks() throws Exception {
        ...
        // First page
        InvestigationResult<IncidentSummary> page1 = investigationService.findIncidents(criteria, 0, 10);
        assertEquals(10, page1.getItemCount());
        assertEquals(25, page1.getTotalCount());
        assertTrue(page1.hasMore());

        // Second page
        InvestigationResult<IncidentSummary> page2 = investigationService.findIncidents(criteria, 1, 10);
        assertEquals(10, page2.getItemCount());
        assertEquals(25, page2.getTotalCount());
        assertTrue(page2.hasMore());

        // Third page
        InvestigationResult<IncidentSummary> page3 = investigationService.findIncidents(criteria, 2, 10);
    ...
    private String createTestIncident(String incidentId, String severity, String status) throws Exception {
        return createTestIncidentAt(incidentId, severity, status, Instant.now());
    }

    private String createTestIncidentAt(String incidentId, String severity, String status, Instant createdAt) 
            throws Exception {
    ...
    private String createTestIncidentWithCorrelation(String incidentId, String severity, String status, 
    ...
    private void createTestEvidence(String incidentId, String evidenceId, String ruleName) throws Exception {
    ...
    private void createTestTimelineEvent(String incidentId, String eventType, Instant timestamp, long sequence) 
            throws Exception {
