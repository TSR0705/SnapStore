...
class EventBusConcurrencyStressTest {
    ...
    void testConcurrentPublishers() throws Exception {
        ...
        assertEquals(publisherCount * eventsPerPublisher, receivedCount.get(),
    ...
    void testEventBurstHandling() throws Exception {
        ...
        assertTrue(receivedLatch.await(10, TimeUnit.SECONDS),
                "All burst events should be processed");
    }
    ...
    void testQueueSaturationRecovery() throws Exception {
        ...
        assertTrue(acceptedEvents < attemptedEvents, "Some events should be rejected when queue is full");
