...
public class ReplayControllerUITest {
  ...
  public void start(Stage stage) throws Exception {
    ...
    com.filex.workspace.WorkspaceState state =
        com.filex.workspace.WorkspaceState.builder().activeIncidentId("INC-TEST-123").build();
  ...
  public void testReplayTimelineDisplay(FxRobot robot) {
    ...
    TimelineEventSummary event1 =
        TimelineEventSummary.builder()
            .timelineId("1")
    ...
    ReplayNavigationService.ReplayWindow window =
        new ReplayNavigationService.ReplayWindow(
    ...
    doAnswer(
        ...
        .replayFromCheckpointAsync(any(), any(), any());
